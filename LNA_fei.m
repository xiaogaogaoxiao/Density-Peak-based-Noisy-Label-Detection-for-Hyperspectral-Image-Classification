function [noise_train_label,noise_train_data,noise_train_data1] = LNA_fei(train_SL,Test_SL,train_labels,train_samples,Test_SL_samples,NL_num)
PretreatmentLabel = [];
NoiseLD = [];
NoiseData = [];
noise_train_data1 = [];
...
for i = 1:max(train_labels)
    ...
    train_labels_1 = ones(1,LabelCount(i)+NL_num)*i;
